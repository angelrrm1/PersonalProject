  ...
  return (
    <section className="container mx-auto px-4 py-12">
      <div className="max-w-2xl mx-auto text-center mb-16">
        ...
        <p className="text-xl text-yellow-300">Choose the plan that&apos;s right for you and your team</p>
      </div>
      ...
      <div className="max-w-3xl mx-auto mt-16 text-center bg-[#0b0b0b] rounded-lg p-8">
        ...
        <p className="text-lg text-yellow-300 mb-8">Contact our sales team to discuss your specific requirements.</p>
        <a
          href="mailto:sales@linearclone.com"
          className="inline-flex h-10 items-center justify-center rounded-md bg-yellow-500 px-8 py-2 text-sm font-medium text-black shadow transition-colors hover:bg-yellow-600 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-yellow-600"
        >
          Contact Sales
        </a>
      </div>
  ...
  return (
    <div
      className={`rounded-lg p-6 ${
        highlighted
          ? 'bg-[#111111] border-2 border-yellow-600 shadow-md relative'
      ...
      <Link
        ...
        className={`w-full inline-flex h-10 items-center justify-center rounded-md px-8 py-2 text-sm font-medium shadow transition-colors ${
          highlighted
            ...
            : 'bg-transparent border border-yellow-700 text-yellow-300 hover:bg-yellow-700/10'
        }`}
      >
        {buttonText}
      </Link>
